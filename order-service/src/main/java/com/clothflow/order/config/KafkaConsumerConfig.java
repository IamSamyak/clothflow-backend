...
public class KafkaConsumerConfig {
    ...
    kafkaErrorHandler(
        ...
        /*
         * 2 retries after the original attempt.
         *
        ...
        /*
         * These errors normally indicate that the Kafka
         * message itself is invalid and retrying it will
         * not fix the message.
         */
    ...
    kafkaListenerContainerFactory(
        ...
        /*
         * Respect Spring Kafka's auto-startup property.
         *
         * Production:
         *     spring.kafka.listener.auto-startup=true
         *     → listeners start normally.
         *
         * Tests:
         *     spring.kafka.listener.auto-startup=false
         *     → listeners are created but not started.
         */
