...
@SpringBootTest
@Testcontainers
class PasswordResetEventConsumerDuplicateIntegrationTest {
    ...
    @Test
    void shouldCreateOnlyOneNotificationForDuplicateKafkaEvent()
            throws Exception {
    ...
    private void waitForNotificationCount(
            long expectedCount
